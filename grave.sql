...
CREATE TABLE `admin` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '公司名',
...
-- ----------------------------
BEGIN;
INSERT INTO `admin` (`id`, `root`, `user_name`, `password`, `name`, `code`, `avatar`, `email`, `phone`, `remark`, `grave_limit`, `create_time`, `update_time`) VALUES (1, 1, 'admin', 'admin', 'admin', 'admin', NULL, NULL, '123', NULL, 7, '2023-07-28 21:47:15', '2023-08-05 23:31:57');
COMMIT;
...
CREATE TABLE `grave` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='墓碑表';
...
CREATE TABLE `grave_url` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='生成的url';
...
CREATE TABLE `member` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='人员表';
...
CREATE TABLE `page` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='页面表';
